...
public class Grafo {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n");
		System.out.println("***************************************");
		System.out.println("Camino mínimo entre 0 y 9 (Ej 1):");
		int origen = 0;
		int destino = 9;
		while (origen != destino) {
			System.out.println(g.siguiente(origen, destino));
		...
		System.out.println("El nodo con más adyacentes es: " + mayor);
		System.out.println("");
		System.out.println("G: " + g.buscarFloidC(4, 9));
		System.out.println("***************************************");
	}
}
